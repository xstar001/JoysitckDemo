...
namespace JoyKeys.DirectInputJoy
{
    ...
    public class Joystick_V : IDisposable
    {
        ...
        /// 方向舵坐标
        /// </summary>
        public int AxisR { get; private set; }

        /// <summary>
        /// 第5轴坐标
        /// </summary>
        public int AxisU { get; private set; }

        /// <summary>
        /// 第6轴坐标
        /// </summary>
        public int AxisV { get; private set; }
        /// <summary>
        /// 返回当前游戏手柄的名称
        /// </summary>
        ...
        public JoystickAPI.JOYCAPS GetJoyStickInfo()
        {
            return JoystickCAPS;
        }
        ...
        private void OnTimerCallback(object state)
        {
            ...
            if (result == JoystickAPI.JOYERR_NOERROR)
            {
                ...
                GetXYZButtons(  infoEx.dwXpos, infoEx.dwYpos, infoEx.dwZpos, 
                                infoEx.dwRpos, infoEx.dwUpos,infoEx.dwVpos,
                                ref buttons);
